...
void iterator_reference_test() {
    ...
    CHECK((*it).m_n == Dummy::eVar);
    CHECK((*it).fnc() == Dummy::eFnc);
    CHECK((*cit).const_fnc() == Dummy::eConst);
    CHECK((*it).virtual_fnc() == Dummy::eVirtual);
    CHECK(it->m_n == Dummy::eVar);
    CHECK(it->fnc() == Dummy::eFnc);
    CHECK(cit->const_fnc() == Dummy::eConst);
    CHECK(it->virtual_fnc() == Dummy::eVirtual);
...
void iterator_difference_test() {
    ...
    CHECK(begin - begin == 0);
    CHECK(end - cb.begin() == 5);
    CHECK(end - end == 0);
    CHECK(begin - cb.end() == -5);
    CHECK(it1 - cb.begin() == 2);
    CHECK(it1 - begin == 2);
    CHECK(end - it1 == 3);
    CHECK(it2 - it1 == 1);
    CHECK(it1 - it2 == -1);
...
void iterator_increment_test() {
    ...
    CHECK(it1 == cb.begin() + 1);
    CHECK(it2 == cb.begin() + 6);
    CHECK(it3 == cb.end());
}
...
void iterator_addition_test() {
    ...
    CHECK(it1 == 5 + cb.begin());
    CHECK(it2 == cb.end());
    CHECK(it3 == cb.end());
    CHECK(it4 + 3 == cb.end());
    CHECK((-3) + it4 == cb.begin() + 4);
    CHECK(cb.begin() + 0 == cb.begin());
}
...
void iterator_comparison_test() {
    ...
    CHECK(it >= cb.begin());
    CHECK(end >= it);
    CHECK(!(begin + 4 < begin + 4));
    CHECK(begin + 4 < begin + 5);
    CHECK(!(begin + 5 < begin + 4));
    CHECK(it < end - 1);
    CHECK(!(end - 1 < it));
}
...
void iterator_invalidation_test() {
    ...
    CHECK(it1.is_valid(0));
    CHECK(it2.is_valid(0));
    CHECK(it3.is_valid(0));
    CHECK(it4.is_valid(0));
    CHECK(it5.is_valid(0));
    CHECK(it6.is_valid(0));

    {
        ...
        CHECK(it1.is_valid(&cb));
        CHECK(it2.is_valid(&ccb));
        CHECK(it3.is_valid(&cb));
        CHECK(it4.is_valid(&cb));
        CHECK(it5.is_valid(&ccb));
        CHECK(it6.is_valid(&cb));
    }
    ...
    it1 = cb1.end();
    it2 = cb2.begin();
    CHECK(it1.is_valid(&cb1));
    CHECK(it2.is_valid(&cb2));
    ...
    CHECK(it1.is_valid(&cb3));
    CHECK(!it2.is_valid(&cb3));
    CHECK(*it2.m_it == 5);
    ...
    CHECK(it1.is_valid(&cb4));
    CHECK(!it2.is_valid(&cb4));
    CHECK(*it2.m_it == 2);
    ...
    CHECK(it1.is_valid(&cb5));
    CHECK(!it2.is_valid(&cb5));
    CHECK(!it3.is_valid(&cb5));
    ...
    CHECK(!it1.is_valid(&cb6));
    CHECK(!it4.is_valid(&cb6));
    CHECK(it2.is_valid(&cb6));
    ...
    it3 = cb7.begin() + 6;
    cb7.linearize();
    CHECK(it1.is_valid(&cb7));
    CHECK(!it2.is_valid(&cb7));
    CHECK(!it3.is_valid(&cb7));
    it1 = cb7.end();
    it2 = cb7.begin();
    it3 = cb7.begin() + 6;
    cb7.linearize();
    ...
    it3 = cb8.begin() + 6;
    cb8.resize(10);
    CHECK(it1.is_valid(&cb8));
    CHECK(it2.is_valid(&cb8));
    CHECK(it3.is_valid(&cb8));
    cb8.resize(20);
    CHECK(it1.is_valid(&cb8));
    CHECK(!it2.is_valid(&cb8));
    CHECK(!it3.is_valid(&cb8));
    ...
    it4 = cb9.begin() + 12;
    cb9 = cb8;
    CHECK(it1.is_valid(&cb9));
    CHECK(!it2.is_valid(&cb9));
    CHECK(!it3.is_valid(&cb9));
    CHECK(!it4.is_valid(&cb9));
    ...
    it4 = cb10.begin() + 7;
    cb10.assign(5, 2);
    CHECK(it1.is_valid(&cb10));
    CHECK(!it2.is_valid(&cb10));
    CHECK(!it3.is_valid(&cb10));
    CHECK(!it4.is_valid(&cb10));
    ...
    it4 = cb11.begin() + 7;
    cb11.assign(15, 5, 2);
    CHECK(it1.is_valid(&cb11));
    CHECK(!it2.is_valid(&cb11));
    CHECK(!it3.is_valid(&cb11));
    CHECK(!it4.is_valid(&cb11));
    ...
    CHECK(it1.is_valid(&cb12));
    CHECK(!it2.is_valid(&cb12));
    CHECK(!it3.is_valid(&cb12));
    CHECK(!it4.is_valid(&cb12));
    ...
    CHECK(it1.is_valid(&cb13));
    CHECK(!it2.is_valid(&cb13));
    CHECK(!it3.is_valid(&cb13));
    CHECK(!it4.is_valid(&cb13));
    ...
    it4 = cb14.begin() + 5;
    cb14.rotate(it2);
    CHECK(it1.is_valid(&cb14));
    CHECK(it2.is_valid(&cb14));
    CHECK(!it3.is_valid(&cb14));
    CHECK(it4.is_valid(&cb14));
    ...
    it4 = cb15.begin() + 5;
    cb15.rotate(it3);
    CHECK(it1.is_valid(&cb15));
    CHECK(it2.is_valid(&cb15));
    CHECK(it3.is_valid(&cb15));
    CHECK(it4.is_valid(&cb15));
    ...
    it4 = cb16.begin() + 5;
    cb16.rotate(it4);
    CHECK(it1.is_valid(&cb16));
    CHECK(!it2.is_valid(&cb16));
    CHECK(it3.is_valid(&cb16));
    CHECK(!it4.is_valid(&cb16));
...
void exception_safety_test() {
    ...
    CHECK_THROWS(cb1.set_capacity(5));
    CHECK(cb1.capacity() == 3);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb1.rset_capacity(5));
    CHECK(cb1.capacity() == 3);
    generic_test(cb1);

    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(circular_buffer<MyInteger>(5, 10));

    circular_buffer<MyInteger> cb3(5, 10);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(circular_buffer<MyInteger>(cb3));

    vector<MyInteger> v(5, MyInteger(10));
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(circular_buffer<MyInteger>(8, v.begin(), v.end()));

    circular_buffer<MyInteger> cb6(5, 10);
    circular_buffer<MyInteger> cb7(8, 3);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb7 = cb6);
    CHECK(cb7.size() == 8);
    CHECK(cb7.capacity() == 8);
    CHECK(cb7[0] == 3);
    CHECK(cb7[7] == 3);
    generic_test(cb7);
    ...
    cb9.push_back(3);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb9.insert(cb9.begin() + 1, 4));
    ...
    cb10.push_back(3);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb10.rinsert(cb10.begin() + 1, 4));

    circular_buffer<MyInteger> cb11(5);
    cb11.push_back(1);
    cb11.push_back(2);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb11.rinsert(cb11.begin(), 1));

    circular_buffer<MyInteger> cb12(5, 1);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb12.assign(4, 2));

    circular_buffer<MyInteger> cb13(5, 1);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb13.assign(6, 2));

    circular_buffer<MyInteger> cb14(5);
    cb14.push_back(1);
    cb14.push_back(2);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb14.insert(cb14.begin(), 10, 3));

    circular_buffer<MyInteger> cb15(5);
    cb15.push_back(1);
    cb15.push_back(2);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb15.insert(cb15.end(), 10, 3));

    circular_buffer<MyInteger> cb16(5);
    cb16.push_back(1);
    cb16.push_back(2);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb16.rinsert(cb16.begin(), 10, 3));

    circular_buffer<MyInteger> cb17(5);
    cb17.push_back(1);
    cb17.push_back(2);
    MyInteger::set_exception_trigger(3);
    CHECK_THROWS(cb17.rinsert(cb17.end(), 10, 3));
    ...
    cb21.push_back(3);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb21.insert(cb21.begin() + 1, 4));
    ...
    cb22.push_back(3);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb22.insert(cb22.end(), 4));

    circular_buffer<MyInteger> cb23(5, 0);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb23.insert(cb23.begin() + 1, 4));
    ...
    cb24.push_back(3);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb24.rinsert(cb24.begin() + 1, 4));

    circular_buffer<MyInteger> cb25(5, 0);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb25.rinsert(cb25.begin() + 3, 4));

    circular_buffer<MyInteger> cb26(5);
    cb26.push_back(1);
    cb26.push_back(2);
    MyInteger::set_exception_trigger(5);
    CHECK_THROWS(cb26.insert(cb26.begin(), 10, 3));

    circular_buffer<MyInteger> cb27(5);
    cb27.push_back(1);
    cb27.push_back(2);
    MyInteger::set_exception_trigger(5);
    CHECK_THROWS(cb27.insert(cb27.end(), 10, 3));

    circular_buffer<MyInteger> cb28(5);
    cb28.push_back(1);
    cb28.push_back(2);
    MyInteger::set_exception_trigger(5);
    CHECK_THROWS(cb28.rinsert(cb28.begin(), 10, 3));

    circular_buffer<MyInteger> cb29(5);
    cb29.push_back(1);
    cb29.push_back(2);
    MyInteger::set_exception_trigger(5);
    CHECK_THROWS(cb29.rinsert(cb29.end(), 10, 3));
    ...
    cb30.push_back(3);
    MyInteger::set_exception_trigger(2);
    CHECK_THROWS(cb30.rinsert(cb30.begin(), 10, 3));
